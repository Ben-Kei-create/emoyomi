        ...
        Work(
            ...
            segments: [
                ...
                TextSegment(
                    ...
                    easyText: "人と話すのが本当に苦手だった。会話のたびに頭が真っ白になって、何を言えばいいかフリーズしてしまう。",
                    emoText: "人と話すとき、\n何を言えばいいかわからなくて、\nいつも言葉が出てこない。",
                ...
                TextSegment(
                    ...
                    easyText: "だから思いついた生存戦略が、みんなの前で「おもしろい人」を演じることだった。",
                    emoText: "だから、\nおどけて笑って、\nピエロになることにした。",
                ...
                TextSegment(
                    ...
                    easyText: "でも結局、何もかも通り過ぎていく。良いことも、悪いことも、全部。",
                    emoText: "結局、\nぜんぶ、\n過ぎていく。",
        ...
        Work(
            ...
            segments: [
                TextSegment(
                    ...
                    easyText: "ある日の夕方のこと。仕事をクビになった男が、荒れ果てた大きな門の下で雨宿りをしていた。",
                    emoText: "夕暮れ。\n仕事を失った男が、\n雨宿りしながら、\nこれからどうするか考えていた。",
                ...
                TextSegment(
                    ...
                    easyText: "だだっ広い門の下に、この男だけがぽつんと座っている。人の気配はまったくない。",
                    emoText: "誰もいない。\nこの広い場所に、\n自分だけ。",
                ...
                TextSegment(
                    ...
                    easyText: "明日の食べ物すらない。頼れる人もいない。完全に行き詰まっていた。",
                    emoText: "明日が見えない。\n何ひとつ、\nあてがない。",
                ...
                TextSegment(
                    ...
                    easyText: "「もう盗みをやるしかない」——そう頭の中で何度も繰り返していた。でも、踏み出せない。",
                    emoText: "もう、盗むしかない。\nそう自分に言い聞かせて、\nでも、まだ動けない。",
                ...
                TextSegment(
                    ...
                    easyText: "男の中で「悪は許さない」という正義感が、たいまつのように一気に燃え上がった。",
                    emoText: "許せない、という感情が\n一気に燃え上がる。\n正義が暴走する。",
                ...
                TextSegment(
                    ...
                    easyText: "男はもう走り出していた。雨の中、京都の街へ向かって。強盗として生きる道を選んだのだ。その後の男の行方を知る者はいない。",
                    emoText: "男は走り出した。\n雨の中へ。\nその先に何があるか、\n誰も知らない。",
        ...
        Work(
            ...
            segments: [
                ...
                TextSegment(
                    ...
                    easyText: "メロスは政治のことなんて何も知らない。田舎で羊の世話をしながら、のんびり暮らしていただけの青年だ。",
                    emoText: "難しいことはわからない。\nただの田舎の羊飼い。\nでも、理不尽はわかる。",
                ...
                TextSegment(
                    ...
                    easyText: "メロスは親友に命をかけて約束した——「3日以内に必ず戻る」と。",
                    emoText: "約束した。\n命をかけて、\n絶対に戻る。",
                ...
                TextSegment(
                    ...
                    easyText: "もっと速く、もっと速く走れ。足が動かなくなっても止まるな。タイムリミットが迫っている。",
                    emoText: "走れ。\nもっと速く。\n間に合わなかったら、\n全部終わる。",
                ...
                TextSegment(
                    ...
                    easyText: "自分を信じて待ってくれている人がいる。今はそのことだけ考えろ。とにかく走れ。",
                    emoText: "信じてくれた人がいる。\nそれだけで、\nまだ走れる。",
                ...
                TextSegment(
                    ...
                    easyText: "理屈なんていらない。友を助ける、それだけを胸に、メロスはひたすら走り続けた。",
                    emoText: "理屈じゃない。\n友のために、\nただ走った。",
        ...
        Work(
            ...
            segments: [
                TextSegment(
                    ...
                    easyText: "ある日のこと。お釈迦様が、極楽にある蓮の池のほとりを、ひとりでのんびり散歩していた。",
                    emoText: "ある日、\nお釈迦様が\n極楽の蓮の池のほとりを\nゆっくり歩いていた。",
                ...
                TextSegment(
                    ...
                    easyText: "ふと池の水面を覗き込むと、はるか下に地獄が広がっていた。この蓮池の真下は、地獄の底とつながっているのだ。",
                    emoText: "ふと、\n池を覗いたら、\nその下は──地獄だった。",
                ...
                TextSegment(
                    ...
                    easyText: "地獄の底で、カンダタという元大泥棒が、大勢の罪人にまみれてもがいているのが見えた。",
                    emoText: "地獄の底で、\nひとりの男が\nもがいていた。",
                ...
                TextSegment(
                    ...
                    easyText: "「この糸は俺のだ！お前ら降りろ！」——カンダタは我を忘れて怒鳴りつけた。",
                    emoText: "「俺のだ！」\n「降りろ！」\nエゴが爆発した。",
                ...
                TextSegment(
                    ...
                    easyText: "その瞬間、蜘蛛の糸はプツッと音を立てて切れた。カンダタは再び地獄の底へ、真っ逆さまに落ちていった。",
                    emoText: "その瞬間、\n糸が切れた。\n救いが消えた。",
                ...
                TextSegment(
                    ...
                    easyText: "あとに残ったのは、極楽から垂れた細い糸だけ。月も星もない真っ暗な空の中で、キラキラと静かに揺れていた。",
                    emoText: "あとには、\nキラキラ光る糸だけが\n暗い空に垂れていた。\n美しくて、残酷。",
        ...
        Work(
            ...
            segments: [
                TextSegment(
                    ...
                    easyText: "自分はその人のことを、ずっと「先生」と呼んでいた。本名は明かさない。ここでも「先生」とだけ書く。",
                    emoText: "あの人のことを、\nずっと「先生」と呼んでいた。\n本当の名前は、まだ言えない。",
                ...
                TextSegment(
                    ...
                    easyText: "誰にも話していない秘密がある。この秘密を抱えたまま、自分はいつか静かにこの世を去るつもりだ。",
                    emoText: "この秘密は、\n誰にも言えない。\nこのまま抱えて、\n消えるつもりだ。",
                ...
                TextSegment(
                    ...
                    easyText: "人間は結局、自分が損しない範囲でだけ、人にやさしくしたいと思う生き物なんだよ。",
                    emoText: "やさしさには限界がある。\n自分が壊れない程度の、\nやさしさしかあげられない。",
                ...
                TextSegment(
                    ...
                    easyText: "恋というのは罪深いものだ。でも同時に、どこか神聖でもある。この矛盾こそが恋の正体だと思う。",
                    emoText: "恋は罪で、\n同時に、聖なるもの。\nこの矛盾が恋の正体。",
                ...
                TextSegment(
                    ...
                    easyText: "もう後戻りできない——その事実が黒い光のように一瞬で未来を貫いた。人生のすべてが絶望の色に染まった。",
                    emoText: "取り返しがつかない。\nその事実が、\n一瞬で人生全部を\n暗く塗りつぶした。",
        ...
        Work(
            ...
            segments: [
                TextSegment(
                    ...
                    easyText: "「じゃあみなさん、『あれは川だ』とか『ミルクがこぼれた跡だ』とか言われてきた、あのぼんやり白く光るもの——正体を知っていますか？」",
                    emoText: "夜空のあの白いもの、\nみんな知ったかぶりしてるけど、\n本当は何なのか知ってる？",
                ...
                TextSegment(
                    ...
                    easyText: "カムパネルラが手を挙げ、何人かがそれに続いた。ジョバンニも挙げかけたけど、自信がなくてやめてしまった。",
                    emoText: "手を挙げたかった。\nでも、挙げられなかった。\n教室で、自分だけ透明になる感覚。",
                ...
                TextSegment(
                    ...
                    easyText: "ジョバンニは言葉が出てこなかった。気づいたら、ただ涙がこぼれていた。",
                    emoText: "言葉にならない。\nただ、涙だけが\n溢れた。",
                ...
                TextSegment(
                    ...
                    easyText: "「カムパネルラ、また二人だけになっちゃったね」——ジョバンニは静かにつぶやいた。",
                    emoText: "また二人きりだ。\nこの瞬間が、いちばん安心する。",
                ...
                TextSegment(
                    ...
                    easyText: "「カムパネルラ、僕たちこのままずっと一緒に旅をしよう。どこまでも、いつまでも。」",
                    emoText: "ずっと一緒にいたい。\nどこまでも、\nいつまでも。",
                ...
                TextSegment(
                    ...
                    easyText: "ふと隣を見ると、カムパネルラの姿が消えていた。さっきまでそこにいたのに。胸に冷たい不安が広がった。",
                    emoText: "いなくなった？\nさっきまで隣にいたのに。\n胸が、ぎゅっとなる。",
                ...
                TextSegment(
                    ...
                    easyText: "「本当の幸せって、何なんだろう」——その問いだけが、ジョバンニの胸にいつまでも残った。",
                    emoText: "本当の幸せって、\nなんだろう。\nまだ、答えは出ない。",
